...
struct in6_addr *firedns_resolveip6_i(const char* name, char *(* const result)(firedns_state*, int));
struct firedns_ip6list *firedns_resolveip6list_i(const char* name, char *(* const result)(firedns_state*, int));
char *firedns_resolvetxt_i(const char* name, char *(* const result)(firedns_state*, int));
struct firedns_txtlist *firedns_resolvetxtlist_i(const char* name, char *(* const result)(firedns_state*, int));
char *firedns_resolvemx_i(const char* name, char *(* const result)(firedns_state*, int));
struct firedns_mxlist *firedns_resolvemxlist_i(const char* name, char *(* const result)(firedns_state*, int));
char *firedns_resolvename4_i(const struct in_addr *  const ip, char *(* const result)(firedns_state*, int));
char *firedns_resolvename6_i(const struct in6_addr *  const ip, char *(* const result)(firedns_state*, int));
